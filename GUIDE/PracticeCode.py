...
def getWeather():
    ...
    img=(Image.open(f"S:\Weather App Project\live img icon\{firstdayimg}@2x.png"))
    ...
    photo2=ImageTk.PhotoImage(file=f"S:\Weather App Project\live img icon\{secondimg}@2x.png")
    ...
    photo3=ImageTk.PhotoImage(file=f"S:\Weather App Project\live img icon\{thirdimg}@2x.png")
    ...
    photo4=ImageTk.PhotoImage(file=f"S:\Weather App Project\live img icon\{fourthimg}@2x.png")
    ...
    photo5=ImageTk.PhotoImage(file=f"S:\Weather App Project\live img icon\{fifthimg}@2x.png")
    ...
    photo6=ImageTk.PhotoImage(file=f"S:\Weather App Project\live img icon\{sixthimg}@2x.png")
    ...
    photo7=ImageTk.PhotoImage(file=f"S:\Weather App Project\live img icon\{seventhimg}@2x.png")
...
# search box
search_box = PhotoImage(file="S:\Weather App Project\Rounded Rectangle 3.png")
...
# timezone
timezone = Label(root, font=("Comic Sans MS", 13, 'bold'),
                 fg="black", bg="#aee4f2")
timezone.place(x=815, y=20)

long_lat = Label(root, font=("Comic Sans MS", 10, 'bold'),
                 fg="black", bg="#aee4f2")
long_lat.place(x=810, y=50)
