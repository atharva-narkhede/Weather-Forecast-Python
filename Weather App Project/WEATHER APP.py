...
def getWeather():
    ...
    photo2 = ImageTk.PhotoImage(
        file=f"live img icon\{secondimg}@2x.png")
    ...
    photo3 = ImageTk.PhotoImage(
        file=f"live img icon\{thirdimg}@2x.png")
    ...
    photo4 = ImageTk.PhotoImage(
        file=f"live img icon\{fourthimg}@2x.png")
    ...
    photo5 = ImageTk.PhotoImage(
        file=f"live img icon\{fifthimg}@2x.png")
    ...
    photo6 = ImageTk.PhotoImage(
        file=f"live img icon\{sixthimg}@2x.png")
    ...
    photo7 = ImageTk.PhotoImage(
        file=f"live img icon\{seventhimg}@2x.png")
...
#Popup function to view dev details
def open_popup():
    top = Toplevel(root)
    ...
    popup_img = PhotoImage(file="dev.png")
...
# rainbow boxes
rainbow_box = PhotoImage(file="weather details2.png")
...
wf_text = PhotoImage(file="weatext.png")
weaimage = Label(image=wf_text, bg="#aee4f2")
weaimage.place(x=333, y=10)

# search box
search_box = PhotoImage(file="Rounded Rectangle 3.png")
...
# thinking man
man = PhotoImage(file="man-t32.png")
...
# Bottom Box
firstbox = PhotoImage(file="dbottom gbox.png")
...
##############################
i_button = PhotoImage(file="info button.png")
